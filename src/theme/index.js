export default {
	...
	"fontFamily": {
		...
		"googleMontserratAlternates": "\"Montserrat Alternates\", sans-serif",
		"googleDidactGothic": "\"Didact Gothic\", sans-serif",
		"googleRobotoMono": "\"Roboto Mono\", monospace",
		"googleRaleway": "\"Raleway\", sans-serif",
		"googleAnonymousPro": "\"Anonymous Pro\", monospace",
		"googlePodkova": "\"Podkova\", serif",
		"googleSourceCodePro": "\"Source Code Pro\", monospace",
		"googleNunitoSans": "\"Nunito Sans\", sans-serif",
		"googleManrope": "\"Manrope\", sans-serif",
		"googleAndikaNewBasic": "\"Andika New Basic\", sans-serif",
		"googleAndika": "\"Andika\", sans-serif"
	},
	"font": {
		"headline1": "normal 600 64px/1.2 --fontFamily-googleMontserrat",
		"headline2": "normal 600 42px/1.2 --fontFamily-googleMontserrat",
		"headline3": "normal 600 32px/1.2 --fontFamily-googleMontserrat",
		"base": "normal 300 16px/1.5 --fontFamily-googleInter",
		"lead": "normal 300 20px/1.5 --fontFamily-googlePoppins",
		"test": "1em Inter, sans-serif"
	},
	"boxShadow": {
